...
export default function Forgetpassword() {
  ...
  if (message == "") {
    return (
      <>
        <div className="container pt-5">
          <form onSubmit={sendEmail.handleSubmit} className="my-5">
    ...
    return (
      <>
        <div className="container pt-5">
          <form onSubmit={resetCode.handleSubmit} className="my-5">
    ...
    return (
      <>
        <div className="container pt-5">
          <form onSubmit={resetPassword.handleSubmit} className="my-5">
            <label htmlFor="email">your Email :</label>
            <input
              type="email"
